...
def get_client():
    uri = st.write(f"mongodb+srv://nda-admin:{st.secrets.get('mongo').get('DB_PASSWORD')}@cluster0.jd3nwb7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
st.write(st.secrets.get('mongo').get('DB_PASSWORD'))
client = get_client()
